...
def convert_coordinates(tensor, start_index, conversion, border_pixels='half'):
    ...
    :param np.ndarray tensor: A Numpy nD array containing the four consecutive coordinates
        to be converted somewhere in the last axis.
    :param int start_index: The index of the first coordinate in the last axis of `tensor`.
    :param str conversion: The conversion direction. Can be 'minmax2centroids',
    ...
    :return np.ndarray: A Numpy nD array, a copy of the input tensor with the converted coordinates
...
def intersection_area(boxes1, boxes2, coords='centroids', mode='outer_product', border_pixels='half'):
    ...
    :param np.ndarray boxes1: Either a 1D Numpy array of shape `(4, )` containing the coordinates for one box in the
    ...
    :param np.ndarray boxes2: Either a 1D Numpy array of shape `(4, )` containing the coordinates for one box in the
        format specified by `coords` or a 2D Numpy array of shape `(n, 4)` containing the coordinates for `n` boxes.
        If `mode` is set to 'element_wise', the shape must be broadcast-compatible with `boxes1`.
    :param str coords: The coordinate format in the input arrays. Can be either 'centroids' for the format
        `(cx, cy, w, h)`, 'minmax' for the format `(xmin, xmax, ymin, ymax)`, or 'corners' for the format
        `(xmin, ymin, xmax, ymax)`.
    :param str mode: Can be one of 'outer_product' and 'element-wise'. In 'outer_product' mode, returns an
    ...
    :return np.ndarray: A 1D or 2D Numpy array (refer to the `mode` argument for details) of dtype float containing values with
...
def iou(boxes1, boxes2, coords='centroids', mode='outer_product', border_pixels='half'):
    ...
    :return np.ndarray: A 1D or 2D Numpy array (refer to the `mode` argument for details) of dtype float containing values in [0,1],
