...
def parse_bboxes(ann, classes):
    ...
    :param ann: xml ET parser. The file containing the bounding boxes.
    :param classes: list of classes

    :return np.ndarray: Parsed bounding box co-ordinates of the format `n x 5` where n is
...
def encode_bboxes(ann, bboxes, img_name):
    ...
    :return np.ndarray: the root of the xml file
    """
