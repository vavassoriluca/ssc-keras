...
from keras.layers import Input, Lambda, Flatten, Conv2D, MaxPooling2D, ZeroPadding2D, Dense, Concatenate, \
    BatchNormalization, Activation, Bidirectional, LSTM, Reshape
...
def ssc_300(image_size,
    ...
    """
    Build a Keras model with SSC300 Merged Predictors architecture, see references.
    ...
    fc7_flatten = Flatten(name='fc7_flatten')(fc7)
    conv6_2_flatten = Flatten(name='conv6_2_flat')(conv6_2)
    conv7_2_flatten = Flatten(name='conv7_2_flat')(conv7_2)
    conv8_2_flatten = Flatten(name='conv8_2_flat')(conv8_2)
    conv9_2_flatten = Flatten(name='conv9_2_flat')(conv9_2)

    # Merge the predictors feature maps of conv6_2 and fc7
    fc7_conv6_2 = Concatenate(axis=1)([fc7_flatten, conv6_2_flatten])

    conv6_2_d1 = Dense(hidden_size[0], name='conv6_2_d1')(fc7_conv6_2)
    conv7_2_d1 = Dense(hidden_size[0], name='conv7_2_d1')(conv7_2_flatten)
    conv8_2_d1 = Dense(hidden_size[0], name='conv8_2_d1')(conv8_2_flatten)
    conv9_2_d1 = Dense(hidden_size[0], name='conv9_2_d1')(conv9_2_flatten)

    conv6_2_d1bn = BatchNormalization()(conv6_2_d1)
    conv7_2_d1bn = BatchNormalization()(conv7_2_d1)
    conv8_2_d1bn = BatchNormalization()(conv8_2_d1)
    conv9_2_d1bn = BatchNormalization()(conv9_2_d1)

    conv6_2_r1 = Activation(activation='relu', name='conv6_2_r1')(conv6_2_d1bn)
    conv7_2_r1 = Activation(activation='relu', name='conv7_2_r1')(conv7_2_d1bn)
    conv8_2_r1 = Activation(activation='relu', name='conv8_2_r1')(conv8_2_d1bn)
    conv9_2_r1 = Activation(activation='relu', name='conv9_2_r1')(conv9_2_d1bn)

    conv6_2_d2 = Dense(hidden_size[1], name='conv6_2_d2')(conv6_2_r1)
    conv7_2_d2 = Dense(hidden_size[1], name='conv7_2_d2')(conv7_2_r1)
    conv8_2_d2 = Dense(hidden_size[1], name='conv8_2_d2')(conv8_2_r1)
    conv9_2_d2 = Dense(hidden_size[1], name='conv9_2_d2')(conv9_2_r1)

    conv6_2_d2bn = BatchNormalization()(conv6_2_d2)
    conv7_2_d2bn = BatchNormalization()(conv7_2_d2)
    conv8_2_d2bn = BatchNormalization()(conv8_2_d2)
    conv9_2_d2bn = BatchNormalization()(conv9_2_d2)

    conv6_2_r2 = Activation(activation='relu', name='conv6_2_r2')(conv6_2_d2bn)
    conv7_2_r2 = Activation(activation='relu', name='conv7_2_r2')(conv7_2_d2bn)
    conv8_2_r2 = Activation(activation='relu', name='conv8_2_r2')(conv8_2_d2bn)
    conv9_2_r2 = Activation(activation='relu', name='conv9_2_r2')(conv9_2_d2bn)

    conv6_2_d3 = Dense(hidden_size[2], name='conv6_2_d3')(conv6_2_r2)
    conv7_2_d3 = Dense(hidden_size[2], name='conv7_2_d3')(conv7_2_r2)
    conv8_2_d3 = Dense(hidden_size[2], name='conv8_2_d3')(conv8_2_r2)
    conv9_2_d3 = Dense(hidden_size[2], name='conv9_2_d3')(conv9_2_r2)

    conv6_2_d3bn = BatchNormalization()(conv6_2_d3)
    conv7_2_d3bn = BatchNormalization()(conv7_2_d3)
    conv8_2_d3bn = BatchNormalization()(conv8_2_d3)
    conv9_2_d3bn = BatchNormalization()(conv9_2_d3)

    conv6_2_r3 = Activation(activation='relu', name='conv6_2_r3')(conv6_2_d3bn)
    conv7_2_r3 = Activation(activation='relu', name='conv7_2_r3')(conv7_2_d3bn)
    conv8_2_r3 = Activation(activation='relu', name='conv8_2_r3')(conv8_2_d3bn)
    conv9_2_r3 = Activation(activation='relu', name='conv9_2_r3')(conv9_2_d3bn)

    conv6_2_pred = Dense(n_classes, name='conv6_2_pred')(conv6_2_r3)
    conv7_2_pred = Dense(n_classes, name='conv7_2_pred')(conv7_2_r3)
    conv8_2_pred = Dense(n_classes, name='conv8_2_pred')(conv8_2_r3)
    conv9_2_pred = Dense(n_classes, name='conv9_2_pred')(conv9_2_r3)

    # Concatenate the output of the different predictors
    # Output shape of `predictions`: (batch, n_predictors, n_classes)

    predictions = Concatenate(axis=1, name='predictions1')([conv6_2_pred, conv7_2_pred, conv8_2_pred, conv9_2_pred])
